...
/// Check if EFA (Elastic Fabric Adapter) is available on this system.
///
/// Returns true if libfabric is compiled in and EFA devices are found.
pub fn efa_supported() -> bool {
